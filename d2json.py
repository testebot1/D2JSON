    ...
    for moves in dtape["Clips"]:
      ...
      if moves["__class"] == "MotionClip":
        ...
        if moves["CoachId"] == 1:
          ...
          Moves1Name = moves["ClassifierPath"].replace("world/maps/" + Codename.lower() + "/timeline/moves/","").replace(".png","")
    ...
    for moves in dtape["Clips"]:
      ...
      if moves["__class"] == "MotionClip":
        ...
        if moves["CoachId"] == 2:
          ...
          Moves2Name = moves["ClassifierPath"].replace("world/maps/" + Codename.lower() + "/timeline/moves/","").replace(".png","")
    ...
    for moves in dtape["Clips"]:
      ...
      if moves["__class"] == "MotionClip":
        ...
        if moves["CoachId"] == 3:
          ...
          Moves3Name = moves["ClassifierPath"].replace("world/maps/" + Codename.lower() + "/timeline/moves/","").replace(".png","")
